  ...
  class wSpecials
  {
     ...
     /**
      ...
      public function processWebspecials()
      {
	          ...
	          $validate->addRule('fiance_for_price','numeric', false);
	          $validate->addRule('fiance_for_term','string', false);
	          $validate->addRule('fiance_for_payment_calcu_url','string', false);
          ...
          if (empty(Message::$msgs)) {
              ...
              $data = array(
              		...
              		'fiance_for_price' => $validate->safe->fiance_for_price,
              		'fiance_for_term' => $validate->safe->fiance_for_term,
              		'fiance_for_payment_calcu_url' => $validate->safe->fiance_for_payment_calcu_url,
      ...
      public function processWebspecialsDubs()
      {
      	...
      	if (empty(Message::$msgs)) {
      		...
      		$data = array(
      				...
      				'fiance_for_price' => $wbsp->fiance_for_price,
      				'fiance_for_term' => $wbsp->fiance_for_term,
      				'fiance_for_payment_calcu_url' => $wbsp->fiance_for_payment_calcu_url,
