    ...
    <div class="header">
     ...
     <div class="item">
      ...
      <div class="content">
       ...
       <div class="data inputfinanceforinterestrate" id="financeForInterestRate" ><strong>$ <?php echo Lang::$word->WSP_FINANCE_FOR_INTEREST_RATE;?></strong>:  <input type="number" value="<?php echo $row->finance_for_interest_rate;?>" name="finance_for_interest_rate" fieldname="ws"></div>
      </div>
     <div class="item">
      ...
      <div class="data inputfinancefordownpayment" id="financeForDownPayment" ><strong>$ <?php echo Lang::$word->WSP_FINANCE_FOR_DOWN_PAYMENT;?></strong>:  <input type="number" value="<?php echo $row->finance_for_down_payment;?>" name="finance_for_down_payment" fieldname="ws"></div>
      <div class="data inputfinancefortradeinvalue" id="financeForTradeInValue" ><strong>$ <?php echo Lang::$word->WSP_FINANCE_FOR_PAYMENT_TRADE_IN_VALUE;?></strong>:  <input type="number" value="<?php echo $row->finance_for_trade_in_value;?>" name="finance_for_trade_in_value" fieldname="ws"></div>
      </div>
      <div class="item">
    ...
    $('#single_zero_lease').change(function () {
   	   ...
   	   if (val == 1) {
			...
			$('#leasePrice').show();
   	       ...
   	       $("input[name=single_lease_price]").val('0');
	       ...
	       $('#financeForInterestRate').hide();
	       $('#financeForDownPayment').hide();
	       $('#financeForTradeInValue').hide();

	       $("input[name=finance_for_price]").val('0');
	       $("input[name=finance_for_interest_rate]").val('0');
	       $("input[name=finance_for_down_payment]").val('0');
	       $("input[name=finance_for_trade_in_value]").val('0');
           ...
           $('#leasePrice').hide();
   	       ...
   	       $("input[name=lease_price]").val('0');
	       $("input[name=lease_extras]").val('0');
	       ...
	       $('#financeForInterestRate').val('');
	       $('#financeForDownPayment').val('');
	       $('#financeForTradeInValue').val('');
	        

	   	   $('#financeForPrice').show();
	       $('#financeForTerm').show();
	       $('#financeForPaymentCalcuUrl').show();
	       $('#financeForInterestRate').show();
	       $('#financeForDownPayment').show();
	       $('#financeForTradeInValue').show();
...
<div>
<?php break;?>
  <?php case "webspecials_test": ?>
  <?php $wSpecials->copybulkSpecialsWebspecials();?>
</div>
<?php break;?>
<?php default: ?>
