   ...
   <div class="row screen-50 tablet-50 phone-100">
    ...
    <div class="header">
     ...
     <div class="item">
      ...
      <div class="item">
      <div class="intro inputtagline"><?php echo Lang::$word->WSP_TAGLINE;?>: <input type="text" value="<?php echo $row->tagline;?>" name="tagline" fieldname="ws"></div>
      </div>
      </div>
      </div>
      <div class="row screen-50 tablet-50 phone-100">
      ...
      <div class="content">
       ...
       <div class="item">
       <div class="intro inputsinglelease">Lease or Fiance For: <select name="single_zero_lease" id='single_zero_lease' fieldname="wssl">
            <option value="">-- Select Vehicle Lease or Fiance For... --</option>
       ...
       <div class="data inputfianceforprice" id="fianceForPrice" ><strong>$ Fiance For Price</strong>:  <input type="number" value="<?php echo $row->fiance_for_price;?>" name="fiance_for_price" fieldname="ws"></div>
      </div>
     <div class="item">
      ...
      <div class="data inputfinanceforterm" id="fianceForTerm"><strong>Fiance For Term/Months</strong>:  <input type="text"  value="<?php echo $row->fiance_for_term;?>" name="fiance_for_term" fieldname="ws"></div>
      </div>
      <div class="item">
       ...
       <div class="data inputfianceforpaymentcalcuUrl" id="fianceForPaymentCalcuUrl"><strong>Fiance For Payment Calculator Url</strong>:  <input type="text" value="<?php echo $row->fiance_for_payment_calcu_url;?>" name="fiance_for_payment_calcu_url" fieldname="ws"></div>
      </div>
      <div class="item">
   ...
   <div class="row screen-50 tablet-50 phone-100">
    ...
    <div class="header">
     ...
     <div class="item">
      ...
      <div class="content">
       ...
       <div class="data" id="fianceForPrice" ><strong>$ Fiance For Price</strong>:  <input type="number" name="fiance_for_price"></div>
      </div>
     <div class="item">
       ...
       <div class="data" id="fianceForTerm"><strong>Fiance For Term/Months</strong>:  <input type="text" name="fiance_for_term"></div>
      </div>
      <div class="item">
       ...
       <div class="data" id="leaseTerm" ><strong><?php echo Lang::$word->WSP_LEASE_TERM;?></strong>: <input type="number"  name="lease_term"></div>
        ...
        <div class="data" id="fianceForPaymentCalcuUrl"><strong>Fiance For Payment Calculator Url</strong>:  <input type="text" name="fiance_for_payment_calcu_url"></div>
      </div>
      <div class="item">
    ...
    <div class="wojo divided card qsContent">
      ...
      <div class="content">
       ...
       <div class="item">
       <div class="intro"><?php echo Lang::$word->WSP_DISCLAIMER_TEXT;?><i class="icon pin" data-content="<?php echo Lang::$word->WSP_DO_NOT_USE_DOUBLE_QUOTES;?>"></i>: <textarea name="disclaimer_text"></textarea></div>
      </div>
     <div class="item">
        <div class="intro"><?php echo Lang::$word->WSP_VEHICLE_IMAGE_Url;?>: <input type="text"  name="vehicle_image"></div>
       </div>
      <div class="item">
        <div class="intro"><?php echo Lang::$word->WSP_INVENTORY_URL;?>:   <input type="text"   name="alt_link_url"></div>
      </div>
      <div class="item">
         <div class="intro"><?php echo Lang::$word->WSP_BRAND_LOGO_URL;?><i class="icon pin" data-content="<?php echo Lang::$word->WSP_IMAGE_MUST_BE_XSIZE;?>"></i>: <input type="text"  name="brand_logo_url"></div>
       </div>
       <div class="item">
