...
<link href="<?php echo ADMINURL . '/assets/cache/' . Cache::cssCache(array('css/base.css','css/button.css','css/image.css','css/icon.css','css/flags.css','css/breadcrumb.css','css/tooltip.css','css/form-new.css','css/input.css','css/table.css','css/label.css','css/segment.css','css/message.css','css/divider.css','css/dropdown.css','css/list.css','css/header.css','css/menu.css','css/datepicker.css','css/editor.css','css/feed.css','css/utility.css','css/style.css'),'css');?>" rel="stylesheet" type="text/css" />
        ...
        <?php if (Users::checkAcl("owner","admin")):?>
         ...
         <?php if (Users::checkAcl("owner")):?>
          ...
          <li class="normal"><a class="submenu<?php if (Url::isPartSet(1, array('webspecials', 'makes', 'models', 'bodystyle', 'year', 'deal', 'lease','webspecialsemails'))) echo ' active';?>"><span>Web Specials</span></a>
           ...
           <?php if (Users::checkAcl("owner","admin")):?>
        	<li><a <?php if (in_array("csvnodups", $core->_url)) echo ' class="active"';?> href="<?php echo Url::adminUrl("csvnodups");?>">CSV Import/Export</a></li>
        	<?php endif;?>
           <?php if (Users::checkAcl("owner")):?>
