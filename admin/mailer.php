<?php
   ...
   * @copyright 2014
   * @version $Id: mailer.php, v1.00 2014-10-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo form segment">
  ...
  <form method="post" id="wojo_form" name="wojo_form">
    <div class="two fields">
      <div class="field">
        ...
        <div class="wojo labeled icon input">
          <input type="text" value="<?php echo $core->site_email;?>" name="from" required>
      ...
      <div class="field">
        ...
        <div class="wojo labeled icon input">
          <input type="text" placeholder="<?php echo Lang::$word->EMN_SUJECT;?>" name="subject" required>
          <div class="wojo corner label"> <i class="icon asterisk"></i> </div>
        </div>
      </div>
    </div>
    ...
    <div class="field">
      <textarea class="bodypost" name="body"><?php echo file_get_contents(BASEPATH . "/mailer/" . $core->lang . "/Newsletter_Admin.tpl.php");?></textarea>
    </div>
