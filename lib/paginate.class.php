<?php
  ...
  class Paginator
  {
       ...
       * @return
       */
      public function items_per_pagebyid($id)
      {
      	$items = '';
      	$ipp_array = array(
      			5,
      	...
      	foreach ($ipp_array as $ipp_opt)
      		...
      		"<option value=\"$ipp_opt\">$ipp_opt</option>\n";
      		return ($this->num_pages >= 1) ? "<select data-cover=\"true\" onchange=\"window.location='" . SITEURL . "/" . App::get('Core')->_urlParts .
      		"?id=$id&pg=1&amp;ipp='+this[this.selectedIndex].value+'';return false\">$items</select>\n" : '';
      }
       ...
       * @return
       */
      public function jump_menubyid($id)
      {
      	$option = '';
      	...
      	return ($this->num_pages >= 1) ? "<select data-cover=\"true\" onchange=\"window.location='" . SITEURL . "/" . App::get('Core')->_urlParts .
      	"?id=$id&pg='+this[this.selectedIndex].value+'&amp;ipp=$this->items_per_page';return false\">$option</select>\n" : '';
      }
