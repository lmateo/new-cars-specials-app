      	...
      	if($wspricings){
                ...
                foreach ($wspricings AS $wspricing) {
      			$wsdata = array(
      					...
      					'special_id'  => Validator::sanitize($wspricing->id),
      					'store_letter_ws' => Validator::sanitize($wspricing->store_letter),
      					'stock_id_ws' => Validator::sanitize($wspricing->stock_id),
      					'name' => Validator::sanitize($wspricing->name),
      					'price' => Validator::sanitize($wspricing->price),
      					'ordering' => Validator::sanitize($wspricing->ordering),
      					'active' => Validator::sanitize($wspricing->active)
