      ...
      public function processWebspecials()
      {
          ...
          if (empty(Message::$msgs)) {
              ...
              $data = array(
              		...
              		'finance_for_price' => $validate->safe->finance_for_price,
              		'finance_for_term' => $validate->safe->finance_for_term,
              		'finance_for_payment_calcu_url' => $validate->safe->finance_for_payment_calcu_url,
              		'finance_for_interest_rate' => $validate->safe->finance_for_interest_rate,
              		'finance_for_down_payment' => $validate->safe->finance_for_down_payment,
              		...
              		'custom_marquee_text' => $_POST['custom_marquee_text'],
