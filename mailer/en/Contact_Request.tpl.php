<div style="color:#000;margin-top:20px;margin-left:auto;margin-right:auto;max-width:800px;background-color:#F4F4F4">
  <table style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;background: #F4F4F4; width: 100%; border: 4px solid #bbbbbb;" cellpadding="10" cellspacing="5">
    <tbody>
      ...
      <tr>
        <td style="text-align: left;" valign="top"> Hello [NAME], <br>
          <br>
          You have received new contact request:</td>
      </tr>
      <tr>
        <td style="text-align: left;" valign="top"><b>Contact Details:</b><br>
          <br>
          <table style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;" border="0" cellpadding="5" cellspacing="2" width="100%">
            <tbody>
              <tr>
                <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;" width="150">From:</td>
                <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[SENDER]</td>
              </tr>
              <tr>
                <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">IP</td>
                <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[IP]</td>
              </tr>
              <tr>
                <td colspan="2" style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[MESSAGE]</td>
              </tr>
            </tbody>
          </table></td>
      </tr>
